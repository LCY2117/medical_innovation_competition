...
生成时间：2026-05-26T01:43:24.406000+00:00
...
| 指标 | 当前系统轮记录 | 建议解释 |
| --- | --- | --- |
| T1 触发到分派完成 | 1s | 越短表示系统越快完成并行任务组织 |
| T2 触发到核心施救响应 | 0s | 用于观察核心施救者是否能及时接单或启动处置 |
| T3 触发到 CPR 开始 | 2s | 反映核心施救动作启动速度 |
| T4 触发到 AED 取到 | 6s | 反映 AED 保障者找到并取出 AED 的速度 |
| T5 触发到 AED 送达 | 9s | 反映 AED 取送链路总效率 |
| T6 触发到救护接管 | 12s | 反映环境清障、接应和交接流程 |
